...
#' Functions for mixture estimation based on moments.
#'
#' \tabular{ll}{ Package: \tab mmm\cr Type: \tab Package\cr Version: \tab
...
#'
#' @name mmm
#' @aliases mmm-package mmm
#' @docType package
#' @useDynLib mmm, .registration = TRUE
#' @importFrom Rcpp sourceCpp
#' @author Claus Thorn Ekstrom \email{claus@@rprimer.dk}\cr Maintainer: Claus Thorn Ekstrom
